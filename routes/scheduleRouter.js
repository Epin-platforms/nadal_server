...
import { deleteSchedule, getScheduleWithScheduleId, getSchedulesWithRoomId, getSchedulesWithUid, getUpdateRoomSchedule, getUpdateSchdule, updateSchedule } from "../controllers/schedule/scheduleController.js";
...
router.get('/update-where-my', getUpdateSchdule);
...
router.get('/update-where-room', getUpdateRoomSchedule);
